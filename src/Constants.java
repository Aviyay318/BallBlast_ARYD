public class Constants {
    ...
    public static final int PANEL_THREE_WIDTH = 900;
    public static final int PANEL_THREE_HEIGHT = 1000;
    public static final int RETRY_BUTTON_WIDTH = 200;
    public static final int RETRY_BUTTON_HEIGHT = RETRY_BUTTON_WIDTH / 2;
